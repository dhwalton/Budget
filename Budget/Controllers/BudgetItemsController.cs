...
namespace Budget.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Frequency,CategoryId,BudgetId,Amount")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditModal([Bind(Include = "Id,Name,Frequency,CategoryId,BudgetId,Amount")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Edit","Budgets",new { id = budgetItem.BudgetId });
            }
            ViewBag.BudgetId = new SelectList(db.Budgets, "Id", "Name", budgetItem.BudgetId);
            ViewBag.CategoryId = new SelectList(db.Categories, "Id", "Name", budgetItem.CategoryId);
            return View(budgetItem);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Frequency,CategoryId,BudgetId,Amount")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
                db.Entry(budgetItem).State = EntityState.Modified;
